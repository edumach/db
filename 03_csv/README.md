...
Nepsaný standard je `UTF-8`:

<img src="../img/kodovani-utf8.png" width="500">

Existuje ale celá řada dalších. To bohužel vede k tomu, že text se neuloží správně:

<img src="../img/nespravne-kodovani.png" width="700">

## Formát `TSV`

Jako `CSV`, jen místo `,` nebo `;` je oddělovačem znak tabulátoru:
