...
<img src="../img/lide-tabulka.png" width=600>
...
Tabulku `lide` můžeme vytvořit i pomocí těchto dvou příkazů:
...
4. Podívejte se na kartu **Database Structure** -- bude tam tabulka `lide`.
